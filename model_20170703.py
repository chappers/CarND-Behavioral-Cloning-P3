...
with open('./aggressive-turn4/driving_log.csv') as csvfile:
    reader = csv.reader(csvfile)
    for line in reader:
        bridge_lines.append(line)
        bridge_lines.append(line)
...
for line in bridge_lines:
    ...
    # flippp
    #bridge_images.append(cv2.flip(image,1))
    #bridge_measurements.append(measurement*-1.0)
...
model.fit(X_train, y_train, validation_split=0.35, shuffle=True, epochs=3)


model.save('model_s_20170703.h5')
